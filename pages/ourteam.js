...
export default function OurTeam() {
    return (
        <div className="h-screen bg-blueGray-800 text-white text-opacity-60 font-montserrat text-sm ">
            <Head>
                <link
                    rel="stylesheet"
            ...
            <section className="hero-section rounded mt-10 w-200 h-100">
                    ...
                    <div className="card" >
                        ...
                        <div className="card__content">
                            ...
                            <div class="card__social-media">
                                <a href="https://web.facebook.com/?_rdc=1&_rdr"> <i class="fab fa-facebook-f"></i> </a>
                                <i class="fab fa-twitter"></i>
                                <a href="https://www.linkedin.com/in/doha-khamaiseh-05a728254/"> <i class="fab fa-linkedin-in"></i></a>
